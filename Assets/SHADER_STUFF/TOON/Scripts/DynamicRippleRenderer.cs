...
public class DynamicRippleRenderer : MonoBehaviour
{
	...
	void CreateCamera() {
		...
		rippleCam.transform.rotation = mainCam.transform.rotation; // rotate the camera to face down
